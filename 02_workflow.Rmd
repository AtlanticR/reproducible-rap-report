...
<!-- MMM Edit: because 'sf' is a name, I think it should be written as lower case, even when starting a sentence-->
<!-- CG: updated!-->
...
2.  **Search results**
    ...
    <!-- MMM EDIT: is it specifically cetaceans?  Or are any other marine mammals included (e.g. seals)?-->
    <!-- CG comment: This section is specifically for cetaceans. 
