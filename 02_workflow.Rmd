...
Because users can interactively select the modules and submodules to be included from the Shiny App, not all sections and subsections may be included in the Full Reports (Fig. 3C). 
