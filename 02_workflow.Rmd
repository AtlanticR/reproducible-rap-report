...
* R packages (e.g., the robis R package for accessing the Ocean Biodiversity Information System (OBIS) data; Provoost & Bosch, 2021);
* URL links to the data (e.g., the Government of Canada Open Data portal; Open Data, 2021); and
...
* None: data can be used and freely shared by anyone. This is typical of data that are made publicly available such as through the Canada Open Data Portal (Open Data, 2021), or other online portals such as OBIS (2021) and the Global Biodiversity Information Facility (GBIF, 2021).
...
* This Report is intended for internal DFO use only. Privacy screening (i.e., the rule of 5; see DFO, 2020) is not yet integrated into all data products and summaries generated by the Report.
