...
## Inputs
### Data sources
Data is gathered from multiple DFO and non-DFO sources and are available in a variety of forms. We have adapted our workflows to accommodate these various data types. This has included but is not limited to:
...
2. **Search results**
    ...
    ii. **Context**: Provides information on species habitat such as rockweed presence/absence, and Ecologically and Biologically Sensitive Areas (EBSAs).
...
Line 151: Again, if possible a quantified # of requests and an average response time for each would be fantastic here (But I fully appreciate that this is likely very difficult or impossible to get).

Finnis: Yes, see comment in Introduction. I think it is ~15 but will need to check with Catalina.

Line 159 & 160: This is just a stylistic comment so by all means completely disregard it. In place of "Predicated" here I would use "based" and in line 160 I would use "conceptualization" instead of "ideation". My manuscripts were constantly hammered by my supervisors to use more accessible language in scientific writing while I was in my Master's so this comment is coming from that training (Trauma?). Any stylistic things I come across I'll highlight, but again, these are only suggestions, feel free to keep or throw out any of these.

Finnis: Thank you for the suggestions! I've had similar experiences... but sometimes I can't find the right words. I've changed these.

Line 172: Maybe "used" instead

Finnis: I've made your suggested change, but updated "using R Markdown" to "with R Markdown" on line 174 to reduce the number of times "used" (/user) occurs in this paragraph.

Line 222 - 226: For the flow of this section I feel like this paragraph might be better placed after the actual data sources presented in Line 227 - 234. 

Finnis: Good suggestion, I've moved this.

Line 241 - 247: I'm wondering if it wouldn't be better to present where the data is stored first and then explain the reasoning behind this in terms of how updates or changes to the data could cause errors if the tool used live storage.

Finnis: I have rephrased this section. I have also added a sentence which clarifies a question that came in from our coauthor, after this was sent to you, about how data are updated.

Line 452: Should this be Geodatabase? I did a quick search for Geotabase and I couldn't find anything

Finnis: Definitely a typo. I've fixed this. Thank you!
